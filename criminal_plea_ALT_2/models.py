...
class Constants(BaseConstants):
    name_in_url = 'criminal_plea_ALT_2'
    ...
    def set_payoff_2(self):
        ...
        if p1.participant.id_in_session % 2 == 1:
            if p2.participant.vars['ending_trial_status'] == False and p3.participant.vars['ending_trial_status'] == False:
                ...
                if ((p2.participant.vars['ending_trial_status'] == True and p2.participant.vars['ending_guilt'] == False)
                    and (p3.participant.vars['ending_trial_status'] == False)) or ((p3.participant.vars['ending_trial_status'] == True and p3.participant.vars['ending_guilt'] == False)
                    and (p2.participant.vars['ending_trial_status'] == False)):
                    contribution1 = p1.participant.vars['contribution2_ALT']
                else:
                    ## Next, Innocent/Guilty
                    if (p2.participant.vars['ending_trial_status'] == False and p3.participant.vars['ending_guilt'] == True) or (p2.participant.vars['ending_guilt'] == True or p3.participant.vars['ending_trial_status'] == False):
                        contribution1 = p1.participant.vars['contribution3_ALT']
                    else:
                        ##Next, Acquitted/Acquitted
                        if (p2.participant.vars['ending_trial_status'] == True and p2.participant.vars['ending_guilt'] == False) and (p3.participant.vars['ending_trial_status'] == True and p3.participant.vars['ending_guilt'] == False):
                            contribution1 = p1.participant.vars['contribution4_ALT']
                        else:
                            ## Next, Guilty/Guilty
                            if (p2.participant.vars['ending_guilt'] == True and p3.participant.vars['ending_guilt'] == True):
                                contribution1 = p1.participant.vars['contribution6_ALT']
                            ## Last, Acquitted/Guilty
                            else:
                                contribution1 = p1.participant.vars['contribution5_ALT']
        else:
            contribution1 = p1.participant.vars['contribution1_ALT']
            ...
            if p1.participant.vars['ending_trial_status'] == False and p2.participant.vars['ending_trial_status'] == False:
                ...
                if ((p1.participant.vars['ending_trial_status'] == True and p1.participant.vars['ending_guilt'] == False)
                    and (p2.participant.vars['ending_trial_status'] == False)) or ((p2.participant.vars[
                                                                                   ...
                                                                                   and (p1.participant.vars[
                                                                                            'ending_trial_status'] == False)):
                    contribution3 = p3.participant.vars['contribution2_ALT']
                else:
                    ## Next, Innocent/Guilty
                    if (p1.participant.vars['ending_trial_status'] == False and p2.participant.vars['ending_guilt'] == True) \
                            or (p1.participant.vars['ending_guilt'] == True or p2.participant.vars[
                        'ending_trial_status'] == False):
                        contribution3 = p3.participant.vars['contribution3_ALT']
                    else:
                        ##Next, Acquitted/Acquitted
                        if (p1.participant.vars['ending_trial_status'] == True and p1.participant.vars[
                            'ending_guilt'] == False) and \
                                (p2.participant.vars['ending_trial_status'] == True and p2.participant.vars[
                                    'ending_guilt'] == False):
                            contribution3 = p3.participant.vars['contribution4_ALT']
                        else:
                            ## Next, Guilty/Guilty
                            if (p1.participant.vars['ending_guilt'] == True and p2.participant.vars[
                                'ending_guilt'] == True):
                                contribution3 = p1.participant.vars['contribution6_ALT']
                            ## Last, Acquitted/Guilty
                            else:
                                contribution3 = p3.participant.vars['contribution5_ALT']
        else:
            contribution3 = p3.participant.vars['contribution1_ALT']
        ...
        if p2.participant.id_in_session % 2 == 1:
            if p1.participant.vars['ending_trial_status'] == False and p3.participant.vars[
                'ending_trial_status'] == False:
                if unconditionalcontributions == 0:
                    contribution2 = p2.participant.vars['Cond_contribution_1_0_ALT']
                else:
                    if unconditionalcontributions == 1:
                        contribution2 = p2.participant.vars['Cond_contribution_1_2_ALT']
                    else:
                        if unconditionalcontributions == 2:
                            contribution2 = p2.participant.vars['Cond_contribution_1_4_ALT']
                        else:
                            if unconditionalcontributions == 3:
                                contribution2 = p2.participant.vars['Cond_contribution_1_6_ALT']
                            else:
                                if unconditionalcontributions == 4:
                                    contribution2 = p2.participant.vars['Cond_contribution_1_8_ALT']
                                else:
                                    if unconditionalcontributions == 5:
                                        contribution2 = p2.participant.vars['Cond_contribution_1_10_ALT']
                                    else:
                                        if unconditionalcontributions == 6:
                                            contribution2 = p2.participant.vars['Cond_contribution_1_12_ALT']
                                        else:
                                            if unconditionalcontributions == 7:
                                                contribution2 = p2.participant.vars['Cond_contribution_1_14_ALT']
                                            else:
                                                if unconditionalcontributions == 8:
                                                    contribution2 = p2.participant.vars['Cond_contribution_1_16_ALT']
                                                else:
                                                    if unconditionalcontributions == 9:
                                                        contribution2 = p2.participant.vars['Cond_contribution_1_18_ALT']
                                                    else:
                                                        contribution2 = p2.participant.vars['Cond_contribution_1_20_ALT']
            else:
                ## Next, Innocent/Acquitted
                if ((p1.participant.vars['ending_trial_status'] == True and p1.participant.vars[
                    'ending_guilt'] == False)
                    and (p3.participant.vars['ending_trial_status'] == False)) or ((p3.participant.vars[
                                                                                   ...
                                                                                   and (p1.participant.vars[
                                                                                            'ending_trial_status'] == False)):
                    if unconditionalcontributions == 0:
                        contribution2 = p2.participant.vars['Cond_contribution_2_0_ALT']
                    else:
                        if unconditionalcontributions == 1:
                            contribution2 = p2.participant.vars['Cond_contribution_2_2_ALT']
                        else:
                            if unconditionalcontributions == 2:
                                contribution2 = p2.participant.vars['Cond_contribution_2_4_ALT']
                            else:
                                if unconditionalcontributions == 3:
                                    contribution2 = p2.participant.vars['Cond_contribution_2_6_ALT']
                                else:
                                    if unconditionalcontributions == 4:
                                        contribution2 = p2.participant.vars['Cond_contribution_2_8_ALT']
                                    else:
                                        if unconditionalcontributions == 5:
                                            contribution2 = p2.participant.vars['Cond_contribution_2_10_ALT']
                                        else:
                                            if unconditionalcontributions == 6:
                                                contribution2 = p2.participant.vars['Cond_contribution_2_12_ALT']
                                            else:
                                                if unconditionalcontributions == 7:
                                                    contribution2 = p2.participant.vars['Cond_contribution_2_14_ALT']
                                                else:
                                                    if unconditionalcontributions == 8:
                                                        contribution2 = p2.participant.vars['Cond_contribution_2_16_ALT']
                                                    else:
                                                        if unconditionalcontributions == 9:
                                                            contribution2 = p2.participant.vars[
                                                                'Cond_contribution_2_18_ALT']
                                                        else:
                                                            contribution2 = p2.participant.vars[
                                                                'Cond_contribution_2_20_ALT']
                else:
                    ## Next, Innocent/Guilty
                    if (p1.participant.vars['ending_trial_status'] == False and p3.participant.vars[
                        'ending_guilt'] == True) \
                        ...
                        'ending_trial_status'] == False):
                        if unconditionalcontributions == 0:
                            contribution2 = p2.participant.vars['Cond_contribution_3_0_ALT']
                        else:
                            if unconditionalcontributions == 1:
                                contribution2 = p2.participant.vars['Cond_contribution_3_2_ALT']
                            else:
                                if unconditionalcontributions == 2:
                                    contribution2 = p2.participant.vars['Cond_contribution_3_4_ALT']
                                else:
                                    if unconditionalcontributions == 3:
                                        contribution2 = p2.participant.vars['Cond_contribution_3_6_ALT']
                                    else:
                                        if unconditionalcontributions == 4:
                                            contribution2 = p2.participant.vars['Cond_contribution_3_8_ALT']
                                        else:
                                            if unconditionalcontributions == 5:
                                                contribution2 = p2.participant.vars['Cond_contribution_3_10_ALT']
                                            else:
                                                if unconditionalcontributions == 6:
                                                    contribution2 = p2.participant.vars['Cond_contribution_3_12_ALT']
                                                else:
                                                    if unconditionalcontributions == 7:
                                                        contribution2 = p2.participant.vars['Cond_contribution_3_14_ALT']
                                                    else:
                                                        if unconditionalcontributions == 8:
                                                            contribution2 = p2.participant.vars[
                                                                'Cond_contribution_3_16_ALT']
                                                        else:
                                                            if unconditionalcontributions == 9:
                                                                contribution2 = p2.participant.vars[
                                                                    'Cond_contribution_3_18_ALT']
                                                            else:
                                                                contribution2 = p2.participant.vars[
                                                                    'Cond_contribution_3_20_ALT']
                    else:
                        ##Next, Acquitted/Acquitted
                        if (p1.participant.vars['ending_trial_status'] == True and p1.participant.vars[
                            'ending_guilt'] == False) and \
                                (p3.participant.vars['ending_trial_status'] == True and p3.participant.vars[
                                    'ending_guilt'] == False):
                            if unconditionalcontributions == 0:
                                contribution2 = p2.participant.vars['Cond_contribution_4_0_ALT']
                            else:
                                if unconditionalcontributions == 1:
                                    contribution2 = p2.participant.vars['Cond_contribution_4_2_ALT']
                                else:
                                    if unconditionalcontributions == 2:
                                        contribution2 = p2.participant.vars['Cond_contribution_4_4_ALT']
                                    else:
                                        if unconditionalcontributions == 3:
                                            contribution2 = p2.participant.vars['Cond_contribution_4_6_ALT']
                                        else:
                                            if unconditionalcontributions == 4:
                                                contribution2 = p2.participant.vars['Cond_contribution_4_8_ALT']
                                            else:
                                                if unconditionalcontributions == 5:
                                                    contribution2 = p2.participant.vars['Cond_contribution_4_10_ALT']
                                                else:
                                                    if unconditionalcontributions == 6:
                                                        contribution2 = p2.participant.vars['Cond_contribution_4_12_ALT']
                                                    else:
                                                        if unconditionalcontributions == 7:
                                                            contribution2 = p2.participant.vars[
                                                                'Cond_contribution_4_14_ALT']
                                                        else:
                                                            if unconditionalcontributions == 8:
                                                                contribution2 = p2.participant.vars[
                                                                    'Cond_contribution_4_16_ALT']
                                                            else:
                                                                if unconditionalcontributions == 9:
                                                                    contribution2 = p2.participant.vars[
                                                                        'Cond_contribution_4_18_ALT']
                                                                else:
                                                                    contribution2 = p2.participant.vars[
                                                                        'Cond_contribution_4_20_ALT']
                        else:
                            ## Next, Guilty/Guilty
                            if (p1.participant.vars['ending_guilt'] == True and p3.participant.vars[
                                'ending_guilt'] == True):
                                if unconditionalcontributions == 0:
                                    contribution2 = p2.participant.vars['Cond_contribution_6_0_ALT']
                                else:
                                    if unconditionalcontributions == 1:
                                        contribution2 = p2.participant.vars['Cond_contribution_6_2_ALT']
                                    else:
                                        if unconditionalcontributions == 2:
                                            contribution2 = p2.participant.vars['Cond_contribution_6_4_ALT']
                                        else:
                                            if unconditionalcontributions == 3:
                                                contribution2 = p2.participant.vars['Cond_contribution_6_6_ALT']
                                            else:
                                                if unconditionalcontributions == 4:
                                                    contribution2 = p2.participant.vars['Cond_contribution_6_8_ALT']
                                                else:
                                                    if unconditionalcontributions == 5:
                                                        contribution2 = p2.participant.vars['Cond_contribution_6_10_ALT']
                                                    else:
                                                        if unconditionalcontributions == 6:
                                                            contribution2 = p2.participant.vars[
                                                                'Cond_contribution_6_12_ALT']
                                                        else:
                                                            if unconditionalcontributions == 7:
                                                                contribution2 = p2.participant.vars[
                                                                    'Cond_contribution_6_14_ALT']
                                                            else:
                                                                if unconditionalcontributions == 8:
                                                                    contribution2 = p2.participant.vars[
                                                                        'Cond_contribution_6_16_ALT']
                                                                else:
                                                                    if unconditionalcontributions == 9:
                                                                        contribution2 = p2.participant.vars[
                                                                            'Cond_contribution_6_18_ALT']
                                                                    else:
                                                                        contribution2 = p2.participant.vars[
                                                                            'Cond_contribution_6_20_ALT']
                            ## Last, Acquitted/Guilty
                            else:
                                if unconditionalcontributions == 0:
                                    contribution2 = p2.participant.vars['Cond_contribution_6_0_ALT']
