...
class Constants(BaseConstants):
    name_in_url = 'criminal_principal_agent2_ALT_ORDER'
    players_per_group = 2
    num_rounds = 1

    instructions_template_A = 'criminal_principal_agent2_ALT_ORDER/Instructions_Agent.html'
    instructions_template_P = 'criminal_principal_agent2_ALT_ORDER/Instructions_Principal.html'
...
class Group(BaseGroup):
    ...
    def keep_decisions(self):
        ...
        p1.participant.vars['agent_fixed_pay_1_ALT'] = self.agent_fixed_pay_1
        p1.participant.vars['agent_fixed_pay_2_ALT'] = self.agent_fixed_pay_2
        p1.participant.vars['agent_fixed_pay_3_ALT'] = self.agent_fixed_pay_3
        p1.participant.vars['agent_fixed_pay_4_ALT'] = self.agent_fixed_pay_4
        p1.participant.vars['agent_fixed_pay_5_ALT'] = self.agent_fixed_pay_5

        p2.participant.vars['agent_work_effort_1_ALT'] = self.agent_work_effort_1
        p2.participant.vars['agent_work_effort_2_ALT'] = self.agent_work_effort_2
        p2.participant.vars['agent_work_effort_3_ALT'] = self.agent_work_effort_3
        p2.participant.vars['agent_work_effort_4_ALT'] = self.agent_work_effort_4
        p2.participant.vars['agent_work_effort_5_ALT'] = self.agent_work_effort_5
        p2.participant.vars['agent_work_effort_6_ALT'] = self.agent_work_effort_6
        p2.participant.vars['agent_work_effort_7_ALT'] = self.agent_work_effort_7
        p2.participant.vars['agent_work_effort_8_ALT'] = self.agent_work_effort_8
        p2.participant.vars['agent_work_effort_9_ALT'] = self.agent_work_effort_9
        p2.participant.vars['agent_work_effort_10_ALT'] = self.agent_work_effort_10
        p2.participant.vars['agent_work_effort_11_ALT'] = self.agent_work_effort_11
        p2.participant.vars['agent_work_effort_12_ALT'] = self.agent_work_effort_12
        p2.participant.vars['agent_work_effort_13_ALT'] = self.agent_work_effort_13

        p2.participant.vars['contract_accepted_1_ALT'] = self.contract_accepted_1
        p2.participant.vars['contract_accepted_2_ALT'] = self.contract_accepted_2
        p2.participant.vars['contract_accepted_3_ALT'] = self.contract_accepted_3
        p2.participant.vars['contract_accepted_4_ALT'] = self.contract_accepted_4
        p2.participant.vars['contract_accepted_5_ALT'] = self.contract_accepted_5
        p2.participant.vars['contract_accepted_6_ALT'] = self.contract_accepted_6
        p2.participant.vars['contract_accepted_7_ALT'] = self.contract_accepted_7
        p2.participant.vars['contract_accepted_8_ALT'] = self.contract_accepted_8
        p2.participant.vars['contract_accepted_9_ALT'] = self.contract_accepted_9
        p2.participant.vars['contract_accepted_10_ALT'] = self.contract_accepted_10
        p2.participant.vars['contract_accepted_11_ALT'] = self.contract_accepted_11
        p2.participant.vars['contract_accepted_12_ALT'] = self.contract_accepted_12
        p2.participant.vars['contract_accepted_13_ALT'] = self.contract_accepted_13
