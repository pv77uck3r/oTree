...
class Constants(BaseConstants):
    name_in_url = 'criminal_trust2_ALT_ORDER'
    players_per_group = 2
    num_rounds = 1
...
class Group(BaseGroup):
    ...
    def keep_decisions(self):
        p1 = self.get_player_by_id(1)
        p2 = self.get_player_by_id(2)
        p1.participant.vars['investor_decision1_ALT'] = self.investor_decision1
        p1.participant.vars['investor_decision2_ALT'] = self.investor_decision2
        p1.participant.vars['investor_decision3_ALT'] = self.investor_decision3
        p1.participant.vars['investor_decision4_ALT'] = self.investor_decision4
        p1.participant.vars['investor_decision5_ALT'] = self.investor_decision5
        p1.participant.vars['initial_role_ALT'] = p1.role

        p2.participant.vars['trustee_decision1_ALT'] = self.trustee_decision1
        p2.participant.vars['trustee_decision2_ALT'] = self.trustee_decision2
        p2.participant.vars['trustee_decision3_ALT'] = self.trustee_decision3
        p2.participant.vars['trustee_decision4_ALT'] = self.trustee_decision4
        p2.participant.vars['trustee_decision5_ALT'] = self.trustee_decision5
        p2.participant.vars['trustee_decision6_ALT'] = self.trustee_decision6
        p2.participant.vars['trustee_decision7_ALT'] = self.trustee_decision7
        p2.participant.vars['trustee_decision8_ALT'] = self.trustee_decision8
        p2.participant.vars['trustee_decision9_ALT'] = self.trustee_decision9
        p2.participant.vars['trustee_decision10_ALT'] = self.trustee_decision10
        p2.participant.vars['initial_role_ALT'] = p2.role
...
class Player(BasePlayer):
    ...
    def record_number(self):
        self.participant.vars['thefourthone'] = [self.session.config['app_sequence'].index('criminal_trust2_ALT_ORDER')]